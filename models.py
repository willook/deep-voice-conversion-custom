...
from modules import prenet, cbhg, normalize, cnn
...
class Net1(ModelDesc):
    ...
    def _get_inputs(self):
        return [InputDesc(tf.float32, (None, None, hp.default.n_mfcc*3), 'x_mfccs'),
    ...
    def network(self, x_mfcc, is_training):
        ...
        out = cnn(out, hp.train1.num_banks, hp.train1.hidden_units,
